  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="font-bold text-blue-600">
            <span style={{ color: COLORS.text }} className="">
      ...
      <motion.div
        ...
        className={`flex flex-col lg:flex-row items-center justify-center gap-36 px-4 py-12 lg:py-28 text-white ${COLORS.titel_bg}`}
        initial="hidden"
        data-aos="fade-up"
        animate="visible"
        variants={fadeIn}
      >
        <motion.div
          className="w-full lg:w-1/3 max-w-[14rem]"
          variants={slideIn}
        >
          <img
        ...
        <motion.div className="w-full lg:w-1/2 max-w-2xl" variants={slideIn}>
          <div className="flex">
            <CheckCircle2
              className={`${COLORS.white_color} w-6 h-6 mr-2 flex-shrink-0`}
            />
            <p
              className={`${COLORS.white_color} text-lg mb-4 text-center lg:text-left`}
            >
          ...
          <motion.h3
            ...
            variants={slideIn}
          >
            <span className={`${COLORS.white_color} font-bold`}>
              {pageContent.feature_1.title}
            </span>
          </motion.h3>

          <motion.p
            className={`${COLORS.white_color} text-lg mb-8 text-center lg:text-left`}
            variants={slideIn}
          >
      ...
      <motion.div
        ...
        className={`${COLORS.secondaryBackground} flex flex-col lg:flex-row items-center justify-center gap-8 px-4 py-12 lg:py-28 text-white`}
        initial="hidden"
        data-aos="fade-up"
        animate="visible"
        variants={fadeIn}
      >
        ...
        <motion.div className="w-full lg:w-1/2 max-w-2xl" variants={slideIn}>
          <div className="flex">
            <Bell className="w-6 h-6 mr-2 flex-shrink-0 text-blue-400" />
            <p className="text-lg mb-4 text-center lg:text-left">
              {pageContent.dataCentricAI.mainTitle}
            </p>
          </div>
          <motion.h3
            className="text-3xl lg:text-5xl font-semibold mb-6 text-center lg:text-left"
